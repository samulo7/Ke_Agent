...
CONFIG_RULES: tuple[ConfigRule, ...] = (
    ...
    ConfigRule(
        ...
        default="false",
        parser=parse_bool,
        description="Enable DingTalk travel-reimbursement approval creation after explicit confirmation.",
        remediation="Set DINGTALK_REIMBURSE_APPROVAL_ENABLED to true/false.",
    ),
    ConfigRule(
        ...
        default="",
        parser=parse_str,
        description="DingTalk approval process code for travel reimbursement submission.",
        remediation="Set DINGTALK_REIMBURSE_APPROVAL_PROCESS_CODE to your reimbursement approval process code.",
    ),
    ConfigRule(
        key="DINGTALK_REIMBURSE_FIELD_TRAVEL_INSTANCE",
        category="dingtalk",
        required=False,
        default="关联出差申请",
        parser=parse_str,
        description="Form component name for linked travel application process instance id.",
        remediation="Set DINGTALK_REIMBURSE_FIELD_TRAVEL_INSTANCE to the field name in your approval form.",
    ),
    ConfigRule(
        key="DINGTALK_REIMBURSE_FIELD_COMPANY",
        category="dingtalk",
        required=False,
        default="公司",
        parser=parse_str,
        description="Form component name for fixed company field.",
        remediation="Set DINGTALK_REIMBURSE_FIELD_COMPANY to the field name in your approval form.",
    ),
    ConfigRule(
        key="DINGTALK_REIMBURSE_FIELD_DEPARTMENT",
        category="dingtalk",
        required=False,
        default="部门",
        parser=parse_str,
        description="Form component name for department field.",
        remediation="Set DINGTALK_REIMBURSE_FIELD_DEPARTMENT to the field name in your approval form.",
    ),
    ConfigRule(
        key="DINGTALK_REIMBURSE_FIELD_COST_COMPANY",
        category="dingtalk",
        required=False,
        default="费用归属公司",
        parser=parse_str,
        description="Form component name for selected cost-company field.",
        remediation="Set DINGTALK_REIMBURSE_FIELD_COST_COMPANY to the field name in your approval form.",
    ),
    ConfigRule(
        key="DINGTALK_REIMBURSE_FIELD_DATE",
        category="dingtalk",
        required=False,
        default="日期",
        parser=parse_str,
        description="Form component name for reimbursement date field.",
        remediation="Set DINGTALK_REIMBURSE_FIELD_DATE to the field name in your approval form.",
    ),
    ConfigRule(
        key="DINGTALK_REIMBURSE_FIELD_AMOUNT",
        category="dingtalk",
        required=False,
        default="金额(元)",
        parser=parse_str,
        description="Form component name for reimbursement amount field.",
        remediation="Set DINGTALK_REIMBURSE_FIELD_AMOUNT to the field name in your approval form.",
    ),
    ConfigRule(
        key="DINGTALK_REIMBURSE_FIELD_OVER_5000",
        category="dingtalk",
        required=False,
        default="是否超过5千",
        parser=parse_str,
        description="Form component name for over-5000 flag field.",
        remediation="Set DINGTALK_REIMBURSE_FIELD_OVER_5000 to the field name in your approval form.",
    ),
    ConfigRule(
        key="DINGTALK_REIMBURSE_ATTACHMENT_FIELD",
        category="dingtalk",
        required=False,
        default="附件",
        parser=parse_str,
        description="Form component name for reimbursement attachment media_id field.",
        remediation="Set DINGTALK_REIMBURSE_ATTACHMENT_FIELD to the attachment field name in your approval form.",
    ),
    ConfigRule(
        key="DINGTALK_REIMBURSE_ATTACHMENT_MEDIA_TYPE",
        category="dingtalk",
        required=False,
        default="file",
        parser=parse_str,
        description="Media upload type used when sending original reimbursement screenshot to DingTalk.",
        remediation="Set DINGTALK_REIMBURSE_ATTACHMENT_MEDIA_TYPE according to DingTalk media/upload API type.",
    ),
    ConfigRule(
        key="DINGTALK_REIMBURSE_ATTACHMENT_MODE",
        category="dingtalk",
        required=False,
        default="screenshot_only",
        parser=parse_str,
        description="Attachment intake mode for reimbursement workflow; current rollout is locked to screenshot_only.",
        remediation="Set DINGTALK_REIMBURSE_ATTACHMENT_MODE=screenshot_only.",
    ),
    ConfigRule(
        key="DINGTALK_REIMBURSE_VISION_MODEL",
        category="dingtalk",
        required=False,
        default="qwen-vl-ocr-latest",
        parser=parse_str,
        description="Vision model used for reimbursement screenshot OCR and structured extraction.",
        remediation="Set DINGTALK_REIMBURSE_VISION_MODEL to the approved multimodal Qwen model name.",
    ),
    ConfigRule(
        key="DINGTALK_REIMBURSE_VISION_API_KEY",
        category="dingtalk",
        required=False,
        parser=parse_str,
        description="Dedicated API key for reimbursement screenshot vision extraction; overrides the shared LLM key when set.",
        remediation="Set DINGTALK_REIMBURSE_VISION_API_KEY to route reimbursement screenshots to a dedicated multimodal provider.",
    ),
    ConfigRule(
        key="DINGTALK_REIMBURSE_VISION_BASE_URL",
        category="dingtalk",
        required=False,
        parser=parse_str,
        description="Dedicated OpenAI-compatible endpoint for reimbursement screenshot vision extraction; overrides the shared LLM base URL when set.",
        remediation="Set DINGTALK_REIMBURSE_VISION_BASE_URL to the dedicated reimbursement vision endpoint URL.",
    ),
    ConfigRule(
        key="DINGTALK_REIMBURSE_FIXED_COMPANY",
        category="dingtalk",
        required=False,
        default="YXQY",
        parser=parse_str,
        description="Fixed company value submitted in reimbursement payload.",
        remediation="Set DINGTALK_REIMBURSE_FIXED_COMPANY to the fixed company code required by finance.",
    ),
    ConfigRule(
        key="DINGTALK_REIMBURSE_COMPANY_OPTIONS",
        category="dingtalk",
        required=False,
        default="YXQY,YXXX,DL,SZB,BWZC,ZZZC,LNTL,YNC,SY,JA,YL,DR",
        parser=parse_str,
        description="Comma-separated selectable cost-company options displayed during reimbursement workflow.",
        remediation="Set DINGTALK_REIMBURSE_COMPANY_OPTIONS as comma-separated company codes.",
    ),
    ConfigRule(
        key="DINGTALK_REIMBURSE_TRAVEL_LOOKBACK_DAYS",
        category="dingtalk",
        required=False,
        default="30",
        parser=parse_positive_int,
        description="Lookback window (days) for listing approved travel applications.",
        remediation="Set DINGTALK_REIMBURSE_TRAVEL_LOOKBACK_DAYS to a positive integer.",
    ),
    ConfigRule(
        key="DINGTALK_REIMBURSE_TRAVEL_LOOKUP_ENABLED",
        category="dingtalk",
        required=False,
        default="false",
        parser=parse_bool,
        description="Enable DingTalk approved travel-application lookup for reimbursement workflow.",
        remediation="Set DINGTALK_REIMBURSE_TRAVEL_LOOKUP_ENABLED to true/false.",
    ),
    ConfigRule(
        ...
        default="",
        parser=parse_str,
        description="DingTalk process code for travel application approval used in reimbursement linkage lookup.",
        remediation="Set DINGTALK_TRAVEL_APPROVAL_PROCESS_CODE when travel lookup is enabled.",
    ),
    ConfigRule(
        key="DINGTALK_REIMBURSE_TRAVEL_LOOKUP_PAGE_SIZE",
        category="dingtalk",
        required=False,
        default="20",
        parser=parse_positive_int,
        description="Page size for travel approval instance id lookup requests.",
        remediation="Set DINGTALK_REIMBURSE_TRAVEL_LOOKUP_PAGE_SIZE to a positive integer.",
    ),
    ConfigRule(
